...
```{r}
ggplot(data = penguins_data_from_csv, aes(x = culmen_depth_mm, y = color)) +
  geom_histogram() +
  theme_bw() +
  scale_fill_viridis_d() +
   labs(title = "Culmen Depth by Species",
       subtitle = "3 penguin species observed on their culmen depth",
       x = "Culmen Depth (mm)",
       y = "Species")
